...
from ail.common.pytorch_util import asarray_shape2d, count_vars, disable_gradient
...
class SAC(OffPolicyAgent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.q_params = chain(self.critic.parameters(), self.critic_target.parameters())
        ...
        self.tau = tau
        self.one = th.ones(1, requires_grad=False).to(self.device)
    ...
    def update(self):
        ...
        train_logs = self.update_sac(data)
        return train_logs
    ...
    def update_critic(self, states, actions, rewards, dones, next_states):
        ...
        self.one_gradient_step(
            (loss_critic1 + loss_critic2), self.optim_critic, self.critic
        )
